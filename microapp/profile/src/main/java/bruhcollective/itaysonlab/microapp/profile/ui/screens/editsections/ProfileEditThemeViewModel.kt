...
internal class ProfileEditThemeViewModel @Inject constructor(
    ...
    fun commitChanges(onChangesCommitted: (ProfileEditEvent) -> Unit) {
        ...
        viewModelScope.launch {
            ...
            onChangesCommitted(ProfileEditEvent.ProfileItemChanged(
                type = currentSectionType,
                item = availableItems.first { it.id == currentItemId }.proto
            ))
